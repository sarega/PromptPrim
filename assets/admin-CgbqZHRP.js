...
`),s=n+t,a=new Blob([s],{type:"text/csv;charset=utf-8;"}),o=URL.createObjectURL(a),l=document.createElement("a");l.setAttribute("href",o),l.setAttribute("download",`account_log_${e.userName}.csv`),document.body.appendChild(l),l.click(),document.body.removeChild(l)}function xe(e){W=e;const n=S(e);if(!(!n||!h||!_||!D)){if(_.textContent=`Account Log for ${n.userName}`,!n.logs||n.logs.length===0)D.innerHTML="<p>No account activity recorded.</p>";else{const t=[...n.logs].reverse().map(s=>{if(typeof s.event=="string"){const a=parseFloat(s.amountUSD)||0,o=parseFloat(s.balanceAfterUSD).toFixed(6),l=a>=0?"color: var(--success-color);":"color: var(--error-color);",d=`${a>=0?"+":""}${a.toFixed(a>=0?2:8)}`;return`
    ...
    `,n}function b(){const e=document.getElementById("user-list-container"),n=document.getElementById("user-search-input").value.toLowerCase(),t=document.getElementById("user-plan-filter").value;if(!e)return;const a=ne().filter(o=>o&&o.plan&&(t==="all"||o.plan===t)&&(!n||o.userName.toLowerCase().includes(n)||o.email.toLowerCase().includes(n)||o.userId.toLowerCase().includes(n)));e.innerHTML="",a.forEach(o=>e.appendChild(Ae(o)))}function P(e){B=e;const n=document.getElementById("user-detail-section");if(!n)return;n.dataset.userId=e;const t=S(e);if(!t){n.classList.add("hidden");return}let s="";if(t.plan==="master"){const d=t.subscriptionEndDate?new Date(t.subscriptionEndDate):null,i=d?Math.ceil((d-Date.now())/(1e3*60*60*24)):"N/A",p=i>0?`${i} days remaining`:"Expired";s=`
        ...
        `}const a=K(t.credits.current),o=t.credits.tokenUsage||{prompt:0,completion:0},l=o.prompt+o.completion;n.innerHTML=`
