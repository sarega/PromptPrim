...
`);return n+t}function he(e){const n=S(e);if(!n||!n.activityLog||n.activityLog.length===0){alert("No activity to export.");return}const t=be(n.activityLog),s=new Blob([t],{type:"text/csv;charset=utf-8;"}),a=URL.createObjectURL(s),o=document.createElement("a");o.setAttribute("href",a),o.setAttribute("download",`activity_log_${n.userName}_${new Date().toISOString().slice(0,10)}.csv`),document.body.appendChild(o),o.click(),document.body.removeChild(o)}const k=document.getElementById("activity-log-modal"),C=document.getElementById("activity-log-body"),R=document.getElementById("activity-log-title");let M=null;function O(){k.style.display="flex"}function Ie(){k.style.display="none"}function Y(e){M=e;const n=S(e);if(!n||!C||!R)return;if(R.textContent=`Activity Log for ${n.userName}`,!n.activityLog||n.activityLog.length===0){C.innerHTML="<p>No activity recorded for this user.</p>",O();return}const t=n.activityLog.map(s=>{const a=(s.promptTokens||0)+(s.completionTokens||0),o=s.duration>0?((s.completionTokens||0)/s.duration).toFixed(1):"N/A",l=(s.costUSD||0).toFixed(8),d=s.usageIsEstimated?'<span class="estimate-indicator" title="This is an estimate.">*</span>':"";return`
    ...
    `,O()}function $e(){const e=document.getElementById("user-detail-section");e&&e.addEventListener("click",n=>{if(n.target.id==="view-activity-log-btn"){const t=e.dataset.userId;Y(t)}}),k?.querySelectorAll(".modal-close-btn")?.forEach(n=>{n.addEventListener("click",Ie)}),k?.querySelector("#export-activity-csv-btn")?.addEventListener("click",()=>{M&&he(M)})}const h=document.getElementById("account-log-modal"),D=document.getElementById("account-log-body"),H=document.getElementById("account-log-title");let W=null;function Se(){h&&(h.style.display="flex")}function Ee(){h&&(h.style.display="none")}function Ue(){const e=S(W);if(!e||!e.logs)return;const n=`Timestamp,Event,Details,Amount (USD),Balance After (USD)
...
`),s=n+t,a=new Blob([s],{type:"text/csv;charset=utf-8;"}),o=URL.createObjectURL(a),l=document.createElement("a");l.setAttribute("href",o),l.setAttribute("download",`account_log_${e.userName}.csv`),document.body.appendChild(l),l.click(),document.body.removeChild(l)}function xe(e){W=e;const n=S(e);if(!(!n||!h||!H||!D)){if(H.textContent=`Account Log for ${n.userName}`,!n.logs||n.logs.length===0)D.innerHTML="<p>No account activity recorded.</p>";else{const t=[...n.logs].reverse().map(s=>{if(typeof s.event=="string"){const a=parseFloat(s.amountUSD)||0,o=parseFloat(s.balanceAfterUSD).toFixed(6),l=a>=0?"color: var(--success-color);":"color: var(--error-color);",d=`${a>=0?"+":""}${a.toFixed(a>=0?2:8)}`;return`
                    <tr>
                        <td>${$(s.timestamp)}</td>
                        <td>${s.details}</td>
    ...
    `,n}function b(){const e=document.getElementById("user-list-container"),n=document.getElementById("user-search-input").value.toLowerCase(),t=document.getElementById("user-plan-filter").value;if(!e)return;const a=ne().filter(o=>o&&o.plan&&(t==="all"||o.plan===t)&&(!n||o.userName.toLowerCase().includes(n)||o.email.toLowerCase().includes(n)||o.userId.toLowerCase().includes(n)));e.innerHTML="",a.forEach(o=>e.appendChild(Ae(o)))}function P(e){B=e;const n=document.getElementById("user-detail-section");if(!n)return;n.dataset.userId=e;const t=S(e);if(!t){n.classList.add("hidden");return}let s="";if(t.plan==="master"){const l=t.subscriptionEndDate?new Date(t.subscriptionEndDate):null,d=l?Math.ceil((l-Date.now())/(1e3*60*60*24)):"N/A",i=d>0?`${d} days remaining`:"Expired";s=`
...
`}),t}function we(){const e=q(),n=z(),t=De(e,n),s=new Blob([t],{type:"text/csv;charset=utf-8;"}),a=URL.createObjectURL(s),o=document.createElement("a");o.setAttribute("href",a),o.setAttribute("download",`financial_report_${new Date().toISOString().slice(0,10)}.csv`),document.body.appendChild(o),o.click(),document.body.removeChild(o)}const N=document.getElementById("financial-report-modal"),_=document.getElementById("financial-report-body");function Me(){N.style.display="flex"}function Pe(){N.style.display="none"}function Fe(){if(!_)return;const e=q(),t=z().map(s=>`
        <tr>
            <td>${s.userName}</td>
            <td>${s.plan}</td>
